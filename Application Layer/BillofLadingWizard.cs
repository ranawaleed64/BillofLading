    ...
    internal class BillofLadingWizard
    {
        ...
        public void LoadblWizard(string aCardCode)
        {
            try
            {
                ...
                oGrid.DataTable.ExecuteQuery($@"SELECT  'N' AS ""Select"",b.""DocNum"",a.""U_ContNo"", b.""U_VN"" from ""@BLC_BOLD"" b Inner Join ""@BLC_BLD1"" a on b.""DocEntry"" = a.""DocEntry""    WHERE  b.""Canceled""='N' AND b.""U_ARPosted""='N' and a.""U_ContNo"" IS NOT NULL and b.""U_VC"" = '{aCardCode}'");
        ...
        public void DataBind(SAPbouiCOM.Form aform)
        {
            ...
            //strQuery = $@" SELECT 'N' AS ""Select"", ""DocNum"", ""U_BN"",""U_VC"", ""U_VN"" FROM ""@BLC_BOLD"" WHERE ""U_VC"" IN ({aCardCode}) and ""Canceled""='N'  and ""U_ARPosted""='N'  ORDER BY ""DocNum"" ";
